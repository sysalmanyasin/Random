...
export function supabaseConfigScreenHTML() {
  return `
    <div class="card" style="text-align:center; padding:28px 20px;">
      ...
      <input type="text" id="supabase-url-input" class="settings-input" placeholder="https://xxxx.supabase.co" aria-label="Supabase project URL">
      <input type="text" id="supabase-anon-key-input" class="settings-input" placeholder="sb_publishable_... (or anon key)" aria-label="Supabase anon or publishable key">
...
export function loginScreenHTML() {
  return `
    <div class="card" style="text-align:center; padding:32px 20px;">
      ...
      <input type="tel" id="login-phone-input" class="settings-input" placeholder="Phone number" inputmode="tel" aria-label="Phone number">
      <input type="password" id="login-pin-input" class="settings-input" placeholder="PIN" inputmode="numeric" style="text-align:center; letter-spacing:4px;" aria-label="PIN">
